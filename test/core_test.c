...
describe("MiniTest Core", minitest_core)
  ...
  MiniTest* subject = malloc(sizeof(MiniTest));
  subject->assertions = 0;
  subject->test_cases = 0;
  subject->passes = 0;
  subject->failures = 0;
  subject->register_suite = minitest.register_suite;
  subject->register_block = minitest.register_block;
  subject->step_back      = minitest.step_back;
  subject->clear          = minitest.clear;
